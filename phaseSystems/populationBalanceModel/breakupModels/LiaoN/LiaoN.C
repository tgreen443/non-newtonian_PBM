...
{
    defineTypeNameAndDebug(LiaoN, 0);
...
Foam::diameterModels::binaryBreakupModels::LiaoN::LiaoN
(
...
void Foam::diameterModels::binaryBreakupModels::LiaoN::precompute()
{
    LiaoNBase::precompute();
}


void Foam::diameterModels::binaryBreakupModels::LiaoN::
